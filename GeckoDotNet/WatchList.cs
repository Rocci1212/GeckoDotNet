        ...
        private String ParseValue(UInt32 peekValue, WatchDataSize dataSize, UInt32 add, WatchEntry entry)
        {
            ...
            switch (dataSize)
            {
                case WatchDataSize.Bit8:
                    ...
                    {
                        case 0:
                            val = ((UInt32)(peekValue & 0xFF000000) >> 24);
                            break;
                        case 1:
                            val = ((UInt32)(peekValue & 0x00FF0000) >> 16);
                            break;
                        case 2:
                            val = ((UInt32)(peekValue & 0x0000FF00) >> 8);
                            break;
                        default:
                            val = ((UInt32)(peekValue & 0x000000FF) >> 0);
                            break;
                    }
                    entry.lastValue = val;
                ...
                case WatchDataSize.Bit16:
                    ...
                    {
                        case 0:
                            val = ((UInt32)(peekValue & 0xFFFF0000) >> 16);
                            break;
                        default:
                            val = ((UInt32)(peekValue & 0x0000FFFF) >> 0);
                            break;
                    }
                    entry.lastValue = val;
